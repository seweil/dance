            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <Image1 src={iosShare} className="imageTips" />
                        <Image1 src={iosAdd} className="imageTips" />
                        <Image1 src={iosConfirm} className="imageTips" />
                    </li>
                    <li>
                        <b>Android</b><br/>
                        Touch the overflow button (three vertical dots) and choose Add to Home Screen<br/>
                        <Image1 src={android1} maxWidth="200px" className="imageTips" />
                        <Image1 src={android2} maxWidth="200px" className="imageTips" />
                    </li>
                </ul>
                <br/>
                <span className="finePrint"><p>Updated: Thu Jun 28 16:44:54 PDT 2018</p></span>                
            </div>
        );
    }
}
