        ...
        return (
            <div>
                ...
                <ul>
                    <li>
                        <b>Hotel</b><br/>
                        <a target="_blank"  rel="noopener noreferrer" href="http://www.sheratonseattle.com/">Sheraton Seattle Hotel</a>
                        <br/>
                    ...
                    <li>
                        See <a target="_blank" rel="noopener noreferrer" href="https://circlebacktoseattle.com/">circlebacktoseattle.com</a> for&nbsp;
                        <a target="_blank"  rel="noopener noreferrer" href="https://circlebacktoseattle.com/wp-content/uploads/2018/06/Airport-to-Hotels.pdf">airport to hotel instructions</a>,&nbsp;
                        <a target="_blank"  rel="noopener noreferrer" href="https://circlebacktoseattle.com/wp-content/uploads/2018/06/Parking-Options.pdf">parking options</a> and more.
                    </li>
                    <li>
                        <b>Caller school</b><br />
                           Sat June 30 - Wed July 4<br/>
                           <i>Note: Caller shool will be in Jefferson and Issaquah</i> (not Boren) 
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <NavLink to="/schedule" key="/schedule">Thurs July 5 - Sat July 7</NavLink>
                    </li>
               ...
               Send an email to <a target="_top"  rel="noopener noreferrer" href="mailto: cbts.talk@gmail.com"> cbts.talk@gmail.com</a>
                ...
                <br/>
                <br/>
                <span className="finePrint"><p>Updated: Fri Jun 29 22:46:46 DST 2018</p></span>
